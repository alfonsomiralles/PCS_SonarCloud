 ...
 * @version 1.0
 */
public class UsuariosBaja extends javax.swing.JFrame {
    ...
    public static void main(String[] args) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(UsuariosBaja.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
