 ...
 * @version 1.0
 */
public class TrabajosModificacion extends javax.swing.JFrame {
    ...
    /**
     * Constructor TrabajosModificacion
     */
    public TrabajosModificacion() {
        initComponents();
    }
    ...
    public static void main(String[] args) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(TrabajosModificacion.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
            ...
            if (rs.next()) {
                ...
                if (rp.next()) {
                    ...
                    if (rj.next()) {
                        ...
                        ResultSet ro = stmt.executeQuery("SELECT * FROM trabajos_centros WHERE t_nombre_trabajo='" + "" + "' AND t_estado ='Sin Asignar'");
                        if (ro.next()) {
                            stmt.executeUpdate("UPDATE trabajos_centros SET t_cant_operaciones='" + "cantidadOperaciones" + "'WHERE t_nombre_trabajo='" + "nombreTrabajo" + "'");
                            stmt.executeUpdate("UPDATE trabajos_centros SET t_op_rest='" + "cantidadOperaciones" + "'WHERE t_nombre_trabajo='" + "nombreTrabajo" + "'");
                            JOptionPane.showMessageDialog(this, "El Trabajo ha sido modificado con éxito", "Información", 1);
