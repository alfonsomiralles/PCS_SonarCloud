...
public class MenuPrincipal extends javax.swing.JFrame {
    ...
    private void jButton2ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton2ActionPerformed
        ...
        if (c1.equals("Usuarios") && c2.equals("Alta")) {
            ...
            if (acceso == 1) {
                new UsuariosAlta().setVisible(true);
            } else {
            ...
            if (acceso == 1) {
                new UsuariosBaja().setVisible(true);
            } else {
                JOptionPane.showMessageDialog(this, "El usuario no tiene privilegios para ejecutar esta acción", "AVISO!", 0);
            }
            ...
            if (acceso == 1) {
                new UsuariosModificacion().setVisible(true);
            } else {
                JOptionPane.showMessageDialog(this, "El usuario no tiene privilegios para ejecutar esta acción", "AVISO!", 0);
            }
            ...
            if (acceso == 1) {
                new CentrosAlta().setVisible(true);
            } else {
                JOptionPane.showMessageDialog(this, "El usuario no tiene privilegios para ejecutar esta acción", "AVISO!", 0);
            }
            ...
            if (acceso == 1 || acceso == 2) {
                new CentrosModificacion().setVisible(true);
                CentrosModificacion.jTextField5.setText(usuario);
            } else {
                JOptionPane.showMessageDialog(this, "El usuario no tiene privilegios para ejecutar esta acción", "AVISO!", 0);
            }
            ...
            if (acceso == 1) {
                new CentrosBaja().setVisible(true);
                CentrosBaja.jTextField5.setText(usuario);
            } else {
                JOptionPane.showMessageDialog(this, "El usuario no tiene privilegios para ejecutar esta acción", "AVISO!", 0);
            }
            ...
            if (acceso == 1 || acceso == 3) {
                new TrabajosAlta().setVisible(true);
                TrabajosAlta.jTextField5.setText(usuario);
            } else {
                JOptionPane.showMessageDialog(this, "El usuario no tiene privilegios para ejecutar esta acción", "AVISO!", 0);
            }
            ...
            if (acceso == 1 || acceso == 3) {
                new TrabajosModificacion().setVisible(true);
                TrabajosModificacion.jTextField5.setText(usuario);
            } else {
                JOptionPane.showMessageDialog(this, "El usuario no tiene privilegios para ejecutar esta acción", "AVISO!", 0);
            }
            ...
            if (acceso == 1 || acceso == 2 || acceso == 3) {
                new TrabajosBaja().setVisible(true);
                TrabajosBaja.jTextField5.setText(usuario);
            } else {
                JOptionPane.showMessageDialog(this, "El usuario no tiene privilegios para ejecutar esta acción", "AVISO!", 0);
            }
