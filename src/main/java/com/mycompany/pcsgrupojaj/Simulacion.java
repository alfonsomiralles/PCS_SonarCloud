    ...
    private void simular(int segundos) {
        try //modificar el trabajo de la BBDD
        {
            ...
            if (re.next()) {
                ...
                segrest = re.getInt(7);
                cant_op = re.getInt(8);
                ResultSet rs = stmt.executeQuery("SELECT * FROM centros_computacion WHERE c_nombre_centro=''");
                if (rs.next()) {
                        ...
                        if (resultado <= 0) {
                            ...
                            if (tiempo <= segundos) {
                                ...
                                if (rx.next()) {
                                    ...
                                    tiempo = tiempo + 5;
                                    ResultSet rc = stmt.executeQuery("SELECT * FROM centros_computacion WHERE c_nombre_centro=''");
                                    if (rc.next()) {
                                        ...
                                        if (ry.next()) {
                                            ...
                                            ResultSet ra = stmt.executeQuery("SELECT * FROM centros_computacion WHERE c_nombre_centro='" + "" + "'");
                                            if (ra.next()) {
