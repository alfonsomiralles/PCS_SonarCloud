 ...
 * @version 1.0
 */
public class UsuariosAlta extends javax.swing.JFrame {
    ...
    public static void main(String[] args) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(UsuariosAlta.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
